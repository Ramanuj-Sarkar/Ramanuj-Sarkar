...
**Bai L., Sarkar R., Lee F., Wu J.C., Vawter M.P.**
*Exploratory Analysis of Sleep Deprivation Effects on Gene Expression and Regional Brain Metabolism.*
**Complex Psychiatry, 2025** · [doi.org/10.1159/000545461](https://doi.org/10.1159/000545461)
...
| Project | Description |
|---|---|
| [Agentic-ResearchPaperChatbot](https://github.com/Ramanuj-Sarkar/Agentic-ResearchPaperChatbot) | Agentic AI system combining automated document parsing with a conversational chatbot powered by Amazon Bedrock |
| [document-intelligence-project](https://github.com/Ramanuj-Sarkar/document-intelligence-project) | RAG-based Q&A system that ingests questions via Streamlit and retrieves answers from documents using LangChain and Pinecone |
| [mlops-experiment-tracker](https://github.com/Ramanuj-Sarkar/mlops-experiment-tracker) | Lightweight, dependency-free experiment tracking tool for Python — a minimal alternative to MLflow for fast iteration |
| [batch_record_mvp](https://github.com/Ramanuj-Sarkar/batch_record_mvp) | Suite of MVPs for automated batch record analysis in clinical/regulated data environments |
| [sentinelScan](https://github.com/Ramanuj-Sarkar/sentinelScan) | CNN-based crack detection systems (PyTorch/U-Net) with FastAPI inference pipelines and damage heatmap generation |
